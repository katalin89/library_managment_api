package ro.mycode.managerapi.constatnts;

public class Constants {
    public static  final String STUDENT_NOT_FOUND_EXCEPTION="Student not exists";

    public static  final String EMPTY_DATABASE_EXCEPTION="List of books is empty";
